...
const AppConfig = {
  ...
  integration: {
    ...
    sms: {
      ...
      templates: {
        reminder:
          "Recordatorio: Tienes una cita médica el {date} a las {time} con {doctor}",
        confirmation:
          "Tu cita médica ha sido confirmada para el {date} a las {time}",
        cancellation:
          "Tu cita médica del {date} a las {time} ha sido cancelada",
      },
    },
    email: {
      enabled: false,
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log(
    `${currentConfig.app.name} v${currentConfig.app.version} inicializado correctamente`
  );
});
...
AppConfig.supabase = {
  url: "https://pxzfneyporftbfquqllw.supabase.co", // reemplazá con tu URL real
  anonKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB4emZuZXlwb3JmdGJmcXVxbGx3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI0Njk3NjYsImV4cCI6MjA3ODA0NTc2Nn0.t6TlZZ6QsCToRpTXsoLk1wZF5y9Avs0cnsoCqfIRBwY", // reemplazá con tu anon key real
};

// Exportar para que otros scripts (auth.js, turns.js) puedan usarlo
